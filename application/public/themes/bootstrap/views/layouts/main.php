    ...
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo Yii::app()->baseUrl; ?>/">TxtMind.us</a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
                        array('label'=>'My Reminders', 'url'=>array('/me'), 'visible'=>!Yii::app()->user->isGuest),
                    ),
                )); ?>
                ...
                <?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
                        array('label'=>'Fork Me', 'url'=>'https://github.com/fillup/txtmindus'),
